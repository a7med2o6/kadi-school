...
const QUICK_ACTIONS = [
  { href: '/students', label: 'Add Student', permission: 'students:write' },
  { href: '/teachers', label: 'Add Teacher', permission: 'teachers:write' },
  { href: '/classes', label: 'New Class', permission: 'classes:write' },
];
      ...
      <div className="flex items-center gap-md">
        {availableActions.length > 0 && (
          <div className="relative">
            ...
            {quickActionsOpen && (
              <div className="absolute right-0 top-full z-20 mt-1 w-48 rounded border border-border bg-popover py-1 shadow-ambient">
