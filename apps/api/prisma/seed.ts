...
const PERMISSIONS = [
  ...
  { key: 'attendance:read', module: 'attendance', description: 'View student attendance records' },
  { key: 'attendance:write', module: 'attendance', description: 'Record student attendance' },
  { key: 'teacher-attendance:read', module: 'attendance', description: 'View teacher attendance and leave requests' },
  {
    key: 'teacher-attendance:write',
    module: 'attendance',
    description: 'Record teacher attendance and approve/reject leave requests',
  },
  ...
  { key: 'payments:create', module: 'finance', description: 'Record a payment against your own/child\'s invoice' },
